    ...
    public:
      ...
      void add_integrator(const string& iname)
      {
        ...
        if (name == "brownian")
          ...
          this->add<IntegratorMyosin, System&, ForceCompute&, int>(name, _sys, _force_compute, _seed);
        else if (name == "viscoelastic")
          this->add<IntegratorViscoelastic, System&, ForceCompute&>(name, _sys, _force_compute);
        else if (name == "myosin_diffusion")
          this->add<IntegratorMyosinDiffusion, System&, ForceCompute&, int>(name, _sys, _force_compute, _seed);
