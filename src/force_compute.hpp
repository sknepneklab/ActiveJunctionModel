...
namespace AJM
{
  ...
  class ForceCompute : public ClassFactory<Force>
  {
    public:
      ...
      double tension(HEHandle<Property>& he, double myo, double l0)
      {
        double T = 0.0;
        for (auto& f : this->factory_map)
          T += f.second->tension(he, myo, l0);
        return T;
      }
      ...
      void add_force(const string& fname)
      {
        ...
        if (name == "area")
          ...
          this->add<ForceHarmonic,System&>(name, _sys);  
        else if (name == "active")
          this->add<ForceActive,System&>(name, _sys);
        else if (name == "active_area")
          this->add<ForceActiveArea,System&>(name, _sys);
        else if (name == "active_spokes")
          this->add<ForceActiveSpokes,System&>(name, _sys);
        else if (name == "harmonic_spokes")
          this->add<ForceHarmonicSpokes,System&>(name, _sys);
        else if (name == "self-propulsion")
          this->add<ForceSelfPropulsion,System&>(name, _sys);
        else if (name == "line-tension")
          this->add<ForceLineTension,System&>(name, _sys);
        else if (name == "angle")
          this->add<ForceAngle,System&>(name, _sys);
        else if (name == "active_direction")
          this->add<ForceActiveDir,System&>(name, _sys);
        else 
