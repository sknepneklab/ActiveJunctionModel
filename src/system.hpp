...
namespace AJM
{
  ...
  typedef map<VertexHandle<Property>, MyoStore<Property> > myostore_map;
  ...
  class System
  {
    public:
      ...
      void read_vertices(const string&);
      void read_faces(const string&);
      void read_boundary(const string&); 
      void read_face_types(const string&); 
      void read_input(const string&, bool = false);

      void set_parameters(double); 
      void set_cell_myosin(int, double);
      void set_cell_myosin_internal(FaceHandle<Property>, double);
      ...
      void set_symmetric_myosin(bool flag) {  _symmetric_myosin = flag; }
      void set_spokes(bool flag) {  _has_spokes = flag; }

      bool symmetric_myosin() { return _symmetric_myosin; }
      bool has_spokes() { return _has_spokes; }
